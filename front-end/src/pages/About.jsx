    ...
    <div>
      ...
      <section className="relative h-screen">
        ...
        <div
          ...
          style={{ opacity: "0.70", backgroundColor: "#001B3A" }}
        ></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 text-white text-center">
          <h2 className="font-serif italic text-5xl md:text-8xl font-bold">
            Understanding
            <br />
            Liver Cancer
          </h2>
          <p className="mt-5 pt-5 italic text-lg arial">
            What do we know about Liver Cancer?
          </p>
        </div>
      </section>
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-lg italic mt-2">
                Liver cells with hepatocellular carcinoma (HCC)
              </p>{" "}
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-4 ml-5 md:p-8">
            <div>
              <h2 className="italic text-3xl md:text-4xl lg:text-4xl sm:text-3xl font-bold mb-4 mt-2">
                What is Liver Cancer?
              </h2>{" "}
              {/* Adjusted text size for different screen sizes */}
              <p className="text-xl xl:text-xl md:text-base sm:text-base mt-10">
                Known as hepatic cancer, it refers to the abnormal growth of
                cells in the
                <br />
                liver. Liver is a vital organ that is responsible for various
                functions
                <br />
                such as detoxification, metabolism and storage of nutrients.
              </p>{" "}
              {/* Adjusted text size for different screen sizes */}
              <br />
              <br />
              <br />
              <h2 className="italic text-3xl md:text-4xl lg:text-4xl sm:text-3xl font-bold mb-4">
                What are the Causes?
              </h2>{" "}
              {/* Adjusted text size for different screen sizes */}
              <p className="text-xl xl:text-xl md:text-base sm:text-base mt-9">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center">
        ...
        ></div>
        {/* Heading */}
        <h2 className="text-lg xl:text-4xl md:text-3xl sm:text-3xl font-bold italic text-center text-white z-10 px-4 py-2">
      ...
      <section className="relative">
        ...
        <div className="italic absolute inset-0 flex flex-col items-center justify-center">
          <div className="text-center">
            <p className="text-white text-lg xl:text-4xl md:text-3xl sm:text-3xl mb-4 md:mb-8">
              "Liver Cancer is the
            </p>
            <p className="text-white text-lg xl:text-4xl md:text-4xl sm:text-3xl font-bold mb-4 md:mb-8">
              6th Most Diagnosed Cancer Worldwide
            </p>
            <p className="text-white text-lg xl:text-4xl md:text-3xl sm:text-3xl mb-4 md:mb-8">
              and the
            </p>
            ...
            <br />
            <p className="text-white text-sm md:text-sm mb-4 md:mb-8 mr-4 md:mr-4">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center">
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl lg:text-5xl sm:text-3xl font-bold mb-4">
                About Us
              </h2>{" "}
              {/* Adjusted text size for different screen sizes */}
              <br />
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-8">
            <div>
              <p className="text-base xl:text-base md:text-base sm:text-base mt-4 mb-4">
                We aim to develop cutting-edge technology
                <br />
                that enhances treatment planning through
                <br />
              ...
              <br />
              <br />
              <p className="text-base xl:text-base md:text-base sm:text-base">
                We employ neural operator learning to create
                <br />
                deep learning based models specifically
                <br />
                tailored for radio-frequency (RFA) simulation.
              </p>{" "}
              {/* Adjusted text size for different screen sizes */}
            </div>
          </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-screen-xl w-full flex justify-center">
            ...
            <div className="flex flex-col items-center justify-center w-full">
              <h1 className="text-white text-3xl md:text-3xl lg:text-4xl font-bold pb-10">
                Technology and Medicine
              </h1>
              {/* Vertical line */}
              <div className="mt-5 w-0.5 h-80 bg-white"></div>{" "}
              {/* Adjusted height to h-80 */}
            </div>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-screen-xl w-full flex justify-center">
              {/* Left side */}
              <div className="flex flex-col items-center justify-center w-full md:w-1/2 pr-4">
                {" "}
                {/* Adjusted width to full width on small screens */}
                <div className="pl-4 pt-5">
                  <p className="text-base md:text-lg lg:text-xl xl:text-2xl p-2 text-center font-semibold pt-8 pb-8">
                  ...
                  <p className="text-xs md:text-sm lg:text-base xl:text-lg p-2 text-center pt-8">
                    Employ neural operator learning to construct a<br />
              ...
              {/* Right side */}
              <div className="flex flex-col items-center justify-center w-full md:w-1/2 pl-4">
                {" "}
                {/* Adjusted width to full width on small screens */}
                <div className="pl-4 pt-5">
                  <p className="text-base md:text-lg lg:text-xl xl:text-2xl p-2 text-center font-semibold pt-8 pb-8">
                  ...
                  <p className="text-xs md:text-sm lg:text-base xl:text-lg p-2 text-center pt-8">
                    Use heat generated by high frequency electrical current
                    <br />
                    to treat small liver tumours
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="relative">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center absolute inset-0">
          ...
          <div className="text-center p-8 bg-transparent z-10 w-full lg:w-1/2">
            <h1 className="text-white text-3xl md:text-4xl lg:text-5xl sm:text-3xl font-bold">
              Collaborations and
              <br />
              Partnerships
            </h1>
          ...
          {/* Right side */}
          <div className="p-10 bg-transparent z-10 w-full lg:w-1/2 flex items-center justify-center lg:justify-start">
            {" "}
            ...
            <div className="text-white">
              <div className="flex flex-col mb-8">
                <div className="flex items-center">
                  ...
                  />
                  <p className="text-base md:text-lg lg:text-xl p-2 mb-4 ml-2 lg:ml-10">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-screen-xl w-full flex justify-center">
            ...
            <div className="text-white text-center">
              <h2 className="text-4xl mb-3 xl:text-7xl md:text-6xl sm:text-5xl font-bold">
                Join Us in the Fight
                <br />
                Against Liver Cancer
              </h2>
              <p className="mt-5 pt-5 italic text-base xl:text-base md:text-base sm:text-base arial">
                Explore our vision for the future of our project and our
                <br />
