    ...
    <>
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10">
          <div className="max-w-[800px] mx-auto text-center">
            <h1
              style={{ fontSize: "3rem" }}
              className="md:text-3xl font-bold py-8"
            >
              Next-Gen
            </h1>
            <h1 style={{ fontSize: "3rem" }} className="md:text-3xl font-bold">
              RFA Simulation<br></br>
              <br></br>
              <br></br>
            </h1>
            <TypingEffect
              className="text-lg mb-6"
              strings={["NOL-driven Treatment Planning for Liver Cancer"]}
              typeSpeed={80}
              backSpeed={70}
              loop
            />
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-20">
          <h2 className="text-2xl md:text-3xl font-bold mb-2 text-center py-1">
            Unlocking precision through AI
          </h2>
          <h2 className="text-2xl md:text-3xl font-bold mb-2 text-center py-1">
            for advanced
          </h2>
          <h2 className="text-2xl md:text-3xl font-bold mb-2 text-center py-1">
            liver cancer treatment planning
          </h2>
          <p className="text-lg text-center p-10">
            Revolutionizing healthcare for tomorrow
          </p>
        </div>
      </div>
    </>
